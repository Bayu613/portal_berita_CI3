                                    ...
                                    <div class="trending-top mb-30">
                                        <div class="trend-top-img">
                                            ...
                                            <div class="trend-top-cap">
                                                ...
                                                <h2><a href="details.html"><?= $kk['judul'] ?></a></h2>
                                            </div>
                                        </div>
                                    </div>
                            <?php }
                                    ...
                                    ?>
                                            ...
                                            <div class="trand-right-single d-flex">
                                                <div class="trand-right-img">
                                                    <img style="width:130px; height:100px;" src="<?= base_url('upload/konten/' . $kk['foto']) ?>" alt="">
                                                </div>
                                                <div class="trand-right-cap">
                                                    <span class="color1"><?= $kk['nama_kategori'] ?></span>
                                                    <h4><a href="details.html"><?= $kk['judul'] ?></a></h4>
                                                </div>
                                            </div>
                                    <?php }
                                    } ?>
                                ...
                                <div class="properties__button">
                                    ...
                                    <nav>
                                        <div class="nav nav-tabs" id="nav-tab" role="tablist">
                                            <a class="nav-item nav-link" href="<?= base_url("welcome") ?>">All</a>
                                            <?php
                                            $expsrv = explode('/', $_SERVER['REQUEST_URI']);
                                            $id_kate = $expsrv[4];
                                            $menuz = '';
                                            foreach ($kategori as $kate) {
                                                    $menuz .= '<a href="' . base_url('welcome/kategori/' . $kate['id_kategori'] . '/#kategori') . '" style="font-size: 15px;" class="nav-item nav-link '.$kate['id_kategori'].'">' . $kate['nama_kategori'] . '</a>';
                                                
                                            } 
                                            $pregMenuz = str_replace("nav-link $id_kate", "nav-link active", $menuz);
                                            echo $pregMenuz;
                                            ?>
                                                ...
                                                <?php foreach ($current_page_content as $kk) { ?>
                                                    <div class="col-lg-6 col-md-6">
                                                        <div class="single-what-news mb-100">
                                                            <div class="what-img">
                                                                <img style="height:320px;" src="<?= base_url('upload/konten/' . $kk['foto']) ?>" alt="">
                                                            </div>
                                                            <div class="what-cap">
                                                                <span class="color1"><?= $kk['nama_kategori'] ?></span>
                                                                <h4><a href="#"><?= $kk['judul'] ?></a></h4>
                                                            </div>
                                                        </div>
                                                    </div>
                                                <?php } ?>
